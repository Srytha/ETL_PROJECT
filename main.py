...
# Extraer dimensiones recargadas
dims = recargar_dimensiones(dw_conn)
dim_cliente = dims['dim_cliente']
dim_sede = dims['dim_sede']
dim_estado = dims['dim_estado']
dim_tiempo = dims['dim_tiempo']
dim_hora = dims['dim_hora']
dim_mensajero = dims['dim_mensajero']
dim_novedad = dims['dim_novedad']
...
hecho_novedad = transform.transform_hecho_novedad(df_hecho_novedad, dim_tiempo, dim_mensajero, dim_novedad,dim_hora)
